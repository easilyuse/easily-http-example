...
public class UserServiceImpl implements UserService {
	...
	public User login(UserDTO userDTO) {
		...
		List<User> loginUsers = users.stream().filter(user -> user.getName().equals(userDTO.getName()))
				.filter(user -> user.getPassword().equals(userDTO.getPassword())).collect(Collectors.toList());
